...
Test coverage is minimal — only pure utilities are tested (e.g. [src/utils/shuffle.test.ts](src/utils/shuffle.test.ts)). There is no component/DOM testing setup.
